...
class BorrowHistoryActivity : AppCompatActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        findViewById<CardView>(R.id.borrowingsCard).setOnClickListener {
            val intent = Intent(this, BorrowingsActivity::class.java)
            startActivity(intent)
        }
        findViewById<CardView>(R.id.returnsCard).setOnClickListener {
